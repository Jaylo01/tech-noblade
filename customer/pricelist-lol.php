    ...
    <main class="product-main">
        ...
        <div class="modal-content product-form-container">
            ...
            <form action="payment.php" method="get">
                ...
                <input type="hidden" name="game" value="League of Legends: Wild Rift">
