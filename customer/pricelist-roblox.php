...
<body>
    ...
    <main class="product-main">
        <div class="product-header-row">
            <h2 class="section-title product-title">Roblox (Robux)</h2>
        ...
        <div class="modal-content product-form-container">
            ...
            <form action="payment.php" method="get">
                <!-- Roblox Specific Inputs -->
                <div class="product-form-group">
                    <label for="user-id" class="product-form-label">Roblox Username / User ID:</label>
                    <input type="text" name="userid" id="user-id" placeholder="Username or 12345678" required class="product-form-input">
                </div>
                <div class="product-form-group">
                ...
                <input type="hidden" name="game" value="Roblox (Robux)">
