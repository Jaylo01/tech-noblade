...
<body>
    ...
    <main class="product-main">
        <div class="product-header-row">
            <h2 class="section-title product-title">MLBB Diamonds</h2>
        ...
        <div class="modal-content product-form-container">
            ...
            <form action="payment.php" method="get">
                <!-- MLBB Specific Inputs -->
                <div class="product-form-group flex gap-15">
                    <div class="flex-2">
                        <label for="user-id" class="product-form-label">User ID:</label>
                        <input type="text" name="userid" id="user-id" placeholder="12345678" required class="product-form-input">
                    </div>
                    <div class="flex-1">
                        <label for="zone-id" class="product-form-label">Zone ID:</label>
                        <input type="text" name="zoneid" id="zone-id" placeholder="(1234)" required class="product-form-input">
                    </div>
                </div>
