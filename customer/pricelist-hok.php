...
<body>
    ...
    <main class="product-main">
        <div class="product-header-row">
            <h2 class="section-title product-title">HOK Tokens</h2>
            <a href="products.php" class="btn btn-back-product">Back to Products</a>
        </div>
        <div class="modal-content product-form-container">
            <h3>Honor of Kings Tokens</h3>
            
            <form action="payment.php" method="get">
                <!-- HOK Specific Inputs -->
                <div class="product-form-group">
                    <label for="user-id" class="product-form-label">Player ID:</label>
                ...
                <input type="hidden" name="game" value="Honor of Kings">
